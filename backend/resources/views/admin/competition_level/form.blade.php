...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		...
		<a href="{{ url('/admin/competition-level/list') }}" class="btn btn-sm btn-danger pull-right">Back to List</a>
	</div>
	<div class="card-body">
		<form method="post" action="{{ url('/admin/competition-level/add')}}" enctype="multipart/form-data">
			<div class="row">
				<div class="col-md-6">
